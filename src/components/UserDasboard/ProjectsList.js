    ...
    <>
      ...
      <div className="bg-white rounded-lg overflow-hidden">
        <div className="flex justify-between items-center bg-white border-b border-gray-200 p-2 font-semibold">
          ...
          <div className="w-1/3 text-zinc-400 text-center">
            <p>Created Date</p>
          </div>
          <div className="w-1/3 flex justify-center items-center text-zinc-400">
        ...
        {projects.map((project) => (
          <div
            key={project._id}
            className="flex justify-between items-center gap-4 md:flex-row flex-col bg-white last:border-none border-b border-gray-200 p-3 md:pl-8 pl-3"
          >
            <div className="w-full flex justify-between items-center">
              <div className="w-1/3 font-bold">
                <p className="text-gray-700">{project.name}</p>
              </div>
              <div className="w-1/3 text-gray-500 font-semibold text-center">
            ...
            <div className="flex md:gap-4 gap-2 items-center md:w-fit w-full justify-end relative">
              <button
              ...
              {dropdownVisible === project._id && (
                <div className="absolute top-full right-0 mt-2 bg-white border border-gray-200 shadow-lg rounded-lg z-50">
                  <button
